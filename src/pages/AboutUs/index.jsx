  ...
  return (
    <div>
      ...
      <section className="about-us">
        ...
        <div className="about-us__cardsWrapper">
          <div className="about-us__cardsWrapper-cards">
            <div className="about-us__cardsWrapper-cards-title">5+ Braches</div>
            <div className=" about-us__cardsWrapper-cards-subtitle">
          ...
          <div className="about-us__cardsWrapper-cards">
            <div className="about-us__cardsWrapper-cards-title">
              25,000+ Satisfied Clients
            </div>
            <div className=" about-us__cardsWrapper-cards-subtitle">
              Our organization has served over 25,000 satisfied clients, all with
              a strong commitment to outstanding service and beyond expectations.
              We take pride in building lasting relationships, offering tailored
              solutions, and ensuring client satisfaction at every step.
            </div>
          </div>
          <div className="about-us__cardsWrapper-cards">
            <div className="about-us__cardsWrapper-cards-title">
              98% + Client Satisfacation Rate
            </div>
            <div className=" about-us__cardsWrapper-cards-subtitle">
              Our organization is proud to maintain a 98%+ client satisfaction
              rate, which is a testament to our commitment to excellence. We focus
              on understanding and meeting the unique needs of each client,
              ensuring exceptional service and results.
            </div>
          </div>
        </div>
        <div className="about-us__context">
        ...
        <div className="about-us__context">
          <p className="about-us__context_subtitle">
            ...
            empower our clients to lead full and active lives.
          </p>
        </div>
        <div className="about-us__context">
          <p className="about-us__context_subtitle">
            Our range of services begins from fitting orthoses that are simpler in
            nature, right down to complex prosthetic systems designed from scratch
            for individuals. We do take pride in being able to help in almost all
